...
# TO_EMAIL="to@example.com"
# EOF
#   echo "Please edit '$DEMO_CONFIG' with your actual values and rerun the script."
#   exit 0
# fi
...
# docker exec "$MONGO_CONTAINER" bash -c "mongodump --out /backup/$BACKUP_NAME"
...
# echo "Backup and email notification complete."
